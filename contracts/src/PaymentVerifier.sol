...
contract PaymentVerifier is Ownable {
    ...
    function verifyPaymentView(PaymentAttestation calldata attestation, bytes calldata signature)
        external
        view
        returns (bool valid, address signer)
    {
    ...
    function _hashAttestation(PaymentAttestation calldata attestation)
        internal
        pure
        returns (bytes32)
    {
